 ...
 * <p>
 * 注意：必须保留 AiMessage 中的 thinking 内容，不可剥离。
 * DeepSeek 等思考模型在工具调用后，reasoning_content 必须回传给 API，
 * 否则会报 400 错误：The reasoning_content in the thinking mode must be passed back to the API.
 */
@Slf4j
@Component

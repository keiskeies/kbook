...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col px-6 pt-safe-top page-enter">
      {/* 品牌头部 */}
      <div className="py-8">
        <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-primary shadow-lg shadow-primary/25">
      ...
      <div className="space-y-4">
        ...
        <button
          onClick={handleLogin}
          disabled={loading}
          className="w-full rounded-2xl bg-primary py-3.5 text-sm font-semibold text-primary-foreground disabled:opacity-50 shadow-lg shadow-primary/25 active:scale-[0.98] transition-transform"
        >
          {loading ? '登录中...' : '登录'}
        </button>
      </div>

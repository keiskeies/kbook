...
export default function TermsPage() {
  ...
  return (
    <div className="h-full overflow-y-auto overscroll-contain bg-background">
      <header className="sticky top-0 z-10 flex items-center gap-3 border-b border-border/50 bg-navbar/95 px-4 py-3 backdrop-blur-xl">
      ...
      <div className="mx-auto max-w-2xl px-5 py-6 text-body leading-relaxed text-muted-foreground space-y-6">
        ...
        <section>
          ...
          <p>2.1 本平台为用户提供图书阅读、AI 智能问答与分析、个性化推荐、书架管理、阅读进度同步、AI 速读卡片、辩论讨论、书评互动等服务。</p>
          <p>2.2 本平台保留随时变更、中断或终止部分或全部服务的权利。服务内容发生变更时，本平台将通过适当方式通知用户。</p>
          <p>2.3 本平台中的部分功能需要用户注册并登录后方可使用。</p>
        </section>

        <section>
          <h2 className="mb-2 text-base font-bold text-foreground">三、账号注册与管理</h2>
          <p>3.1 用户注册时需提供邮箱地址、设置密码，并可能需要提供出生日期、性别、婚姻状况、子女情况、MBTI 人格类型等基本信息用于个性化推荐。用户应对所提供信息的真实性、合法性负责。</p>
        ...
        <section>
          ...
          <p>5.3 用户在本平台发表的原创内容（如评论、书评、笔记等），其知识产权归用户所有，但用户授予本平台在全球范围内免费的、非独占的使用许可。</p>
        </section>

        <section>
          <h2 className="mb-2 text-base font-bold text-foreground">六、AI 服务说明</h2>
          <p>6.1 本平台提供的 AI 问答、图书分析、个性化推荐、辩论讨论等服务基于人工智能技术生成，仅供参考，不构成任何专业建议。</p>
          <p>6.2 AI 生成的内容可能存在不准确或不完整之处，用户应自行判断并承担使用风险。</p>
          <p>6.3 本平台不对 AI 生成内容的准确性、完整性和可靠性做出明示或暗示的保证。</p>
          <p>6.4 AI 问答中涉及的图书原文引用仅为辅助理解之用，不替代原著阅读，用户应通过正规渠道获取并阅读完整原著。</p>
          <p>6.5 用户与 AI 的对话记录会被存储在服务器上用于提供连续对话服务。用户提问的内容可能会被发送至第三方 AI 服务提供商（如 OpenAI、DeepSeek 等，具体提供商由平台管理员配置）进行处理，但不会用于训练或改善第三方模型。</p>
        </section>
        ...
        <section>
          ...
          <p>8.3 如用户不同意变更后的协议，可停止使用本平台服务并联系管理员处理账号数据。</p>
        </section>

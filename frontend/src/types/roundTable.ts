...
export const ROLE_TTS_CONFIG: Record<string, { pitch: number; rate: number }> = {
  ...
  PHILOSOPHER: { pitch: 0.8, rate: 0.9 },
  PSYCHOLOGIST: { pitch: 1.1, rate: 1.0 },
  SOCIOLOGIST: { pitch: 0.9, rate: 1.05 },
  SCIENTIST: { pitch: 0.85, rate: 1.1 },
  HISTORIAN: { pitch: 0.8, rate: 0.85 },
  CRITIC: { pitch: 1.15, rate: 0.9 },
  EDUCATOR: { pitch: 0.95, rate: 1.0 },
  STUDENT: { pitch: 1.2, rate: 1.1 },
  WRITER: { pitch: 0.85, rate: 0.9 },
  COMEDIAN: { pitch: 1.15, rate: 1.2 },
  JOURNALIST: { pitch: 1.0, rate: 1.1 },
  ACTOR: { pitch: 1.05, rate: 1.0 },
  DIRECTOR: { pitch: 0.85, rate: 0.95 },
  ARTIST: { pitch: 1.1, rate: 0.9 },
  MUSICIAN: { pitch: 1.1, rate: 0.85 },
  POET: { pitch: 1.05, rate: 0.85 },
  TRANSLATOR: { pitch: 1.0, rate: 0.95 },
  ENTREPRENEUR: { pitch: 0.75, rate: 1.15 },
  INVESTOR: { pitch: 0.8, rate: 1.0 },
  ECONOMIST: { pitch: 0.9, rate: 1.05 },
  STRATEGIST: { pitch: 0.8, rate: 0.9 },
  LAWYER: { pitch: 0.75, rate: 1.0 },
  DOCTOR: { pitch: 0.9, rate: 0.95 },
  FARMER: { pitch: 0.8, rate: 0.9 },
  FIREFIGHTER: { pitch: 0.85, rate: 1.1 },
  NURSE: { pitch: 1.1, rate: 0.95 },
  MEDITATION_TEACHER: { pitch: 0.85, rate: 0.8 },
  PARENT: { pitch: 1.0, rate: 1.0 },
  TRAVELER: { pitch: 1.05, rate: 1.05 },
  TECH_EXPERT: { pitch: 0.8, rate: 1.0 },
  ENGINEER: { pitch: 0.85, rate: 1.05 },
  EDITOR: { pitch: 0.9, rate: 1.0 },
  BOOK_REVIEWER: { pitch: 1.0, rate: 1.1 },
  DIPLOMAT: { pitch: 1.0, rate: 0.95 },
  LIBRARIAN: { pitch: 0.9, rate: 0.9 },
  SOCIAL_WORKER: { pitch: 1.0, rate: 0.95 },
  SPORTS_COACH: { pitch: 0.9, rate: 1.15 },
  ANTHROPOLOGIST: { pitch: 0.9, rate: 1.0 },
  FEMINIST: { pitch: 1.0, rate: 1.05 },
  ECOLOGIST: { pitch: 0.85, rate: 0.95 },
}

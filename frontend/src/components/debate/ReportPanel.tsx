 ...
 */
export default function ReportPanel({ report, isGenerating, onTrigger, onClose }: ReportPanelProps) {
  return (
      ...
      <div className="flex-1 min-h-0 overflow-y-auto overscroll-contain px-4 py-3">
        {!report && !isGenerating && (
          <div className="text-center py-6">
            ...
            <button
              onClick={onTrigger}
              className="inline-flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-orange-400 to-orange-500 px-4 py-2 text-xs font-medium text-white shadow-sm active:scale-[0.97] transition-transform"
            >
        ...
        {report?.status === 'COMPLETED' && report.content && (
          <div>
            {report.bestDebater && (
              <div className="mb-4 rounded-xl border border-amber-200 dark:border-amber-800 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/20 p-4">
            ...
            <div className="[&_h2]:border-border/30 [&_h2]:pb-1.5 [&_h2]:mb-3 [&_h2]:!text-base
                          ...
                          [&_p]:my-2
                          [&_blockquote]:!border-l-4 [&_blockquote]:!border-orange-300 [&_blockquote]:!bg-orange-50/50 dark:[&_blockquote]:!bg-orange-500/10 [&_blockquote]:pl-4
                          [&_strong]:!text-orange-600 dark:[&_strong]:!text-orange-400
                          [&_li]:my-0.5
                          [&_hr]:!my-4
                          [&_ul]:my-2 [&_ol]:my-2

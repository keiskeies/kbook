...
This project is indexed by GitNexus as **kbook** (8245 symbols, 18708 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

...
This project is indexed by GitNexus as **kbook** (7972 symbols, 18082 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
